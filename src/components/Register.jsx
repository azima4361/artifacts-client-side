...
const Register = () => {
  const { createNewUser, setUser, signInByGoogle } = useContext(AuthContext);
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="w-full max-w-lg bg-white shadow-xl rounded-2xl p-8 space-y-6">
        ...
        <div className="text-sm text-gray-500 text-center">or register with email</div>
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="font-medium text-blue-600 ml-1 hover:underline">
            Login
          </Link>
        </p>
      </div>
